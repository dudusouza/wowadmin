...
class Smarty extends Smarty_Internal_TemplateBase
{
    ...
    public function setBlockPluginLang(){
        include_once SMARTY_PLUGINS_DIR.'block.admlang.php';
        include_once SMARTY_PLUGINS_DIR.'block.globallang.php';
        include_once SMARTY_PLUGINS_DIR.'block.lang.php';
        $this->registerPlugin('block', 'admlang', 'smarty_block_lang_adm');
        $this->registerPlugin('block', 'lang', 'smarty_block_lang');
        $this->registerPlugin('block', 'globlang', 'smarty_block_lang_global');
    }
